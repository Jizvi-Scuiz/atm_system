        ...
        if($select1 == $select2){
            ...
            if($acc_bal[0] > $_POST['amount']){
                echo "<div class='container'>Balance available</div>
                    <div class='button-container'> <button class='btn-primary' id='proceed_transfer'> Proceed Transfer </button> </div>
                    <p id='transfer_com'>  </p>";
            }
            else{
...
$(document).hover(function(){
  $("#transfer_com").mousemove(function(){
    $("#proceed_transfer").hide();
  });
});
</script>